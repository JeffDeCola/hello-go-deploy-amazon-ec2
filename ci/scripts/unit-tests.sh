...
echo "cp -R ./hello-go-deploy-amazon-ec2 src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for hello-go-deploy-amazon-ec2" | tee test/test_coverage.txt
# echo " "
