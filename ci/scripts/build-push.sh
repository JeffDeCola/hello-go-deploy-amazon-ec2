...
echo "cp -r hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code/* dist"
cp -r hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code"
#cd src/github.com/JeffDeCola/hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ec2/hello-go-deploy-amazon-ec2-code/build-push/Dockerfile" .
#echo " "
